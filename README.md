# Semantic-role-labeling-with-SNN

Repository for my Bachelor thesis, "Semantic role labeling with spiking neural networks using surrogate gradient learning." This includes the code, the pdf file, and all data and results that I used to write the thesis. I wrote the code & thesis in 1 1/2 months because I had to change topics.
